...
WARRIOR.runStory = async function () {
  ...
  await W.say(`<b>Weighty blade combat — light, heavy, and the parry.</b><br>• <b>PARRY</b> = <b>HOLD Space</b> (or hold the 🛡️ Guard/Parry button). When he winds up his blade <b>flashes</b> — <b>raise your guard on the flash and hold</b> through the blow. Time it and you <b>PARRY: he's stunned</b>. Turtle it up early and you only block. Holding drains stamina, so don't sit on it. You can't swing while guarding — <b>release, then strike</b>.<br>• <b>LIGHT ATTACK</b> = the <b>directions</b> ↑ ↓ ← → / <b>E</b> (rosette): fast, cheap — but a good foe reads a blind swing and counters.<br>• <b>HEAVY</b> = <b>R</b> (or 💥): slow and brutal — smashes a braced guard, but leaves you wide open, so use it when he's <b>not</b> swinging.<br>• When he's <b>stunned</b>, your next blow is a <b>FINISHER</b>. <b>Bait → parry the flash → release → finish.</b>`, { big: true });
